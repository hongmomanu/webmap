...
getHomeR = do
    ...
    defaultLayout $ do
        ...
        addStylesheetRemote   "http://192.168.2.112/OpenLayers-2.13/theme/default/style.css"
        addStylesheet $ StaticR javascripts_resources_css_cf_css
        addScriptRemote   "http://192.168.2.112/OpenLayers-2.13/OpenLayers.js"
        --addScriptRemote   "http://localhost/ext-4.2.1/ext-debug-w-comments.js"
        addScriptRemote   "http://192.168.2.112/ext-4.2.1/examples/shared/include-ext.js"
        addScriptRemote   "http://192.168.2.112/ext-4.2.1/examples/shared/options-toolbar.js"
